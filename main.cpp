...
enum {DONE, ADD_PASSENGER, REMOVE_PASSENGER, ADD_FLIGHT, REMOVE_FLIGHT, FND_P}; 
const int MAX_CHOICE = FND_P;
...
int main(int argc, char** argv)
{
  ...
  while((choice = getChoice()) != DONE)
    switch(choice)
    {
      ...
      case FND_P : flights.findPassenger(); break;
    }  // switch
